...
const THEMES: Record<BackgroundTheme, Layer[]> = {
  ...
  patisserie: [
    { src: '/decor/patisserie/espresso-cup.png', style: { width: '50%',  top: '7%',     right: '-6%',  opacity: 0.20, filter: 'saturate(0.9)' } },
    { src: '/decor/patisserie/macaron.png',      style: { width: '19%',  top: '20%',    right: '30%',  opacity: 0.18, filter: 'saturate(0.75)', transform: 'rotate(-26deg)' } },
    { src: '/decor/patisserie/macaron.png',      style: { width: '19%',  top: '24.5%',  right: '16%',  opacity: 0.16, filter: 'saturate(0.7)',  transform: 'rotate(23deg)' } },
    { src: '/decor/patisserie/coffee-bean.png',  style: { width: '5.4%', top: '9%',     left: '8%',    opacity: 0.30, transform: 'rotate(-22deg)' } },
    { src: '/decor/patisserie/coffee-bean.png',  style: { width: '5.4%', top: '11.5%',  left: '14%',   opacity: 0.24, transform: 'rotate(34deg)' } },
    { src: '/decor/patisserie/strawberry.png',   style: { width: '56%',  top: '43%',    left: '-24%',  opacity: 0.20, filter: 'saturate(0.85)', transform: 'rotate(270deg)' } },
    { src: '/decor/patisserie/croissant.png',    style: { width: '82%',  bottom: '8%',  left: '-15%',  opacity: 0.26, filter: 'saturate(1) contrast(1.02)' } },
    { src: '/decor/patisserie/coffee-bean.png',  style: { width: '5.6%', bottom: '13%', right: '11%',  opacity: 0.40, transform: 'rotate(-18deg)' } },
    { src: '/decor/patisserie/coffee-bean.png',  style: { width: '5.2%', bottom: '10%', right: '6%',   opacity: 0.34, transform: 'rotate(22deg)' } },
    { src: '/decor/patisserie/coffee-bean.png',  style: { width: '5.0%', bottom: '9%',  right: '15%',  opacity: 0.28, transform: 'rotate(-44deg)' } },
  ],
  none: [],
}
