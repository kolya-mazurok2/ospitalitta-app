...
const bitter: MenuSection = {
  ...
  items: [
    ...
    { id: 'negroni', slug: 'negroni', price: '500', glass: 'rocks', lvl: 2, house: true, loved: true,
      ...
      variants: [
        ...
        { label: 'Strawberry & Basil',  price: '500',  posterSrc: '/venue-assets/bottle-brothers/negroni-strawberry-basil.jpg' },
      ],
